    ...
    return (
        <div className='py-16 px-4 flex justify-center'>
            <div className='bg-green-700 p-10 text-center  rounded-circle rounded-lg'>
                <h1 className='text-3xl text-white '>Lead the future of Dream jobber</h1>
               ...
               <Link href="#"  className='bg-green-600  text-white px-5 py-2 rounded-full'>work with Dream jobber</Link>
